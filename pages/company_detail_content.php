<!-- Konten untuk Halaman Detail Perusahaan -->
<div class="company-detail-page">
    <button class="btn btn-secondary btn-back-to-explore" id="backToExploreBtn"><i class="fas fa-arrow-left"></i> Kembali ke Daftar</button>
    ...
    <div id="companyDetailContentContainer" style="display: none;">
        <div class="company-detail-header">
            <div class="company-detail-logo">
                <img src="https://placehold.co/100x100/ccc/999?text=Logo" alt="Company Logo" id="companyDetailLogo">
            </div>
        ...
        <div class="company-detail-banner">
            <img src="https://placehold.co/800x300/eee/ccc?text=Banner+Perusahaan" alt="Company Banner" id="companyDetailBannerImg">
        </div>
        ...
        <div class="company-detail-content">
            ...
            <section class="company-section">
                ...
                <ul id="companyDetailWhyIntern" class="styled-list">
                    <!-- Poin-poin mengapa magang di sini -->
            ...
            <section class="company-section">
                ...
                <div class="company-detail-contact">
                    <ul>
                        ...
                        <li><i class="fas fa-globe icon-contact"></i> <strong>Website:</strong> <a href="#" id="companyDetailWebsite" target="_blank" rel="noopener noreferrer">Website Perusahaan</a></li>
                        <li><i class="fas fa-envelope icon-contact"></i> <strong>Email:</strong> <a href="mailto:" id="companyDetailEmail">Email Kontak</a></li>
                        <li><i class="fas fa-phone icon-contact"></i> <strong>Telepon:</strong> <span id="companyDetailPhone">Telepon Kontak</span></li>
                    </ul>
                </div>
            </section>
        </div>
